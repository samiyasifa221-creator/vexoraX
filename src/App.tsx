    ...
    return (
      <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center font-sans">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-sm font-semibold text-slate-300">Initializing AegisRewards Security Engine...</div>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans flex flex-col selection:bg-indigo-500/30">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h1 className="text-sm font-black tracking-tight text-white">LoopPulse Pro</h1>
      ...
      <footer className="bg-slate-950 border-t border-slate-900 py-4 px-6 text-center text-xs text-slate-400">
        <p>
          LoopPulse Pro • Android 15 (API 35) • Server-Authoritative Anti-Fraud • 8-Link Rotator • Idempotent Points Ledger
        </p>
      </footer>
